...
void Application::Run()
{
	...
	std::string vPath = std::string(RESOURCE_PATH) + "shader.vs";
	std::string fPath = std::string(RESOURCE_PATH) + "shader.fs";
	Shader shader(vPath, fPath);	

	std::string mPath = std::string(RESOURCE_PATH) + "backpack/backpack.obj";
	Model _model(mPath);
